    ...
    DetailsModule = __decorate([
        core_1.NgModule({
            imports: [common_1.CommonModule, router_1.RouterModule, forms_1.FormsModule, primeng_1.DataTableModule, primeng_1.TabViewModule, primeng_1.ButtonModule, primeng_1.DropdownModule, primeng_1.InputTextareaModule,
                primeng_1.InputTextModule, primeng_1.PanelModule, details_routes_1.default, primeng_1.AutoCompleteModule, primeng_1.ConfirmDialogModule],
            providers: [testtemplate_service_1.TestTemplateService, testtype_service_1.TestTypeService, testmode_service_1.TestModeService, testrequirement_service_1.TestRequirementService, primeng_1.ConfirmationService, procedure_service_1.ProcedureService],
