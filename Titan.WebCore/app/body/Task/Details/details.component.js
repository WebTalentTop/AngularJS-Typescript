...
var DetailsComponent = (function () {
    // msgs:Message[];
    // uploadedFiles: any[] = [];
    function DetailsComponent(route, dataService, equipmenttypeservice, router) {
        var _this = this;
        this.route = route;
    ...
    DetailsComponent.prototype.ngOnInit = function () {
        ...
        this.dataService.getTaskDetailsById(this.taskId)
            ...
            _this.entityId = taskres.result.entityId;
    ...
    DetailsComponent.prototype.onChange = function (event) {
    ...
    DetailsComponent.prototype.onCompleteTask = function () {
    ...
    //}
    DetailsComponent.prototype.uploadFile = function (event) {
        for (var _i = 0, _a = event.files; _i < _a.length; _i++) {
            var file = _a[_i];
