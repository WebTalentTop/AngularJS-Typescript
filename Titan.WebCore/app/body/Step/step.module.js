...
var step_routes_1 = require("./step.routes");
var TestFacilitiesModule = (function () {
    function TestFacilitiesModule() {
    }
    TestFacilitiesModule = __decorate([
        core_1.NgModule({
            imports: [common_1.CommonModule, router_1.RouterModule, primeng_1.DataTableModule, primeng_1.InputTextModule, primeng_1.DropdownModule, primeng_1.InputTextareaModule, primeng_1.TabViewModule, grid_module_1.GridModule, step_routes_1.default],
            providers: [testfacility_service_1.TestFacilityService, step_service_1.StepService],
