...
export class AddComponent {
    ...
    constructor(private service: RequirementItemTypeService, private router: Router, private route: ActivatedRoute) {
    ...
    onSubmit(formRef) {
        ...
        this.service.postAdd(formData).subscribe(res => {
            ...
            if (res.isSuccess) {
                ...
                this.router.navigate(["/vehicle/requirementItemType"], { queryParams: { page: 1 } });
