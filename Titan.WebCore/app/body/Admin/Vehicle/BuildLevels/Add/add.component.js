...
var AddComponent = (function () {
    ...
    AddComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            ...
            var buildLevelsAddBreadCrumb = breadC.filter(function (filter) {
                return filter.pageName === 'BuildLevelsAddPage';
            })[0];
            console.log("BreadC -----", breadC);
            console.log("buildLevelsAddBreadCrumb ---------", buildLevelsAddBreadCrumb);
            _this.breadcrumbs = [];
            _this.breadcrumbs = buildLevelsAddBreadCrumb.items;
    ...
    AddComponent.prototype.onSubmit = function (formRef) {
        ...
        this.service.postAdd(formData).subscribe(function (res) {
            ...
            if (res.isSuccess) {
                ...
                _this.router.navigate(["admin/vehicle/buildLevel"], { queryParams: { page: 1 } });
            }
        });
        // );
    };
