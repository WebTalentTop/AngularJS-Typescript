...
var ProjectStatusComponent = (function () {
    function ProjectStatusComponent(breadCrumbsService, service, route, router, logger) {
    ...
    ProjectStatusComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            ...
            var projectStatusBreadCrumb = breadC.filter(function (filter) {
                return filter.pageName === 'ProjectStatusHomePage';
            })[0];
            console.log("BreadC -----", breadC);
            console.log("projectStatusBreadCrumb ---------", projectStatusBreadCrumb);
            _this.breadcrumbs = [];
            _this.breadcrumbs = projectStatusBreadCrumb.items;
    ...
    ProjectStatusComponent.prototype.navigateDetails = function (id) {
