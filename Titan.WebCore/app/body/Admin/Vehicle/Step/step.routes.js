...
var routes = [
    { path: '/:page', component: step_component_1.StepComponent },
    ...
    { path: 'details/:id', canActivate: [authGuard_1.AuthGuard], loadChildren: 'app/body/Admin/Vehicle/Step/Details/details.module' }
];
