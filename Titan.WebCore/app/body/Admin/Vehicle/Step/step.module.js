...
var StepModule = (function () {
    ...
    StepModule = __decorate([
        core_1.NgModule({
            imports: [common_1.CommonModule, primeng_1.DataTableModule, grid_module_1.GridModule, step_routes_1.default, primeng_1.MessagesModule, primeng_1.BreadcrumbModule, primeng_1.GrowlModule],
            providers: [step_service_1.StepService, breadCrumbs_service_1.BreadCrumbsService],
