...
var StepComponent = (function () {
    function StepComponent(breadCrumbsService, service, route, router, logger) {
    ...
    StepComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            ...
            var stepBreadCrumb = breadC.filter(function (filter) {
                return filter.pageName === 'StepHomePage';
            })[0];
            console.log("BreadC -----", breadC);
            console.log("stepBreadCrumb ---------", stepBreadCrumb);
            _this.breadcrumbs = [];
            _this.breadcrumbs = stepBreadCrumb.items;
