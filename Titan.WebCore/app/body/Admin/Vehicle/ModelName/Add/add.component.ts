...
export class AddComponent {
    ...
    constructor(private service: ModelNameService, private router: Router, private route: ActivatedRoute) {
    ...
    onSubmit(formRef) {
        ...
        this.service.postAdd(formData).subscribe(res => {
            ...
            if (res.isSuccess) {
                ...
                this.router.navigate(["/admin/vehicle/modelName"], { queryParams: { page: 1 } });
