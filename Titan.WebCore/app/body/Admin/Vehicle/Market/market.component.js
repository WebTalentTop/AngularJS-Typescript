...
var MarketComponent = (function () {
    function MarketComponent(breadCrumbsService, service, route, router, logger) {
    ...
    MarketComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            ...
            var marketBreadCrumb = breadC.filter(function (filter) {
                return filter.pageName === 'MarketHomePage';
            })[0];
            console.log("BreadC -----", breadC);
            console.log("marketBreadCrumb ---------", marketBreadCrumb);
            _this.breadcrumbs = [];
            _this.breadcrumbs = marketBreadCrumb.items;
    ...
    MarketComponent.prototype.navigateDetails = function (id) {
