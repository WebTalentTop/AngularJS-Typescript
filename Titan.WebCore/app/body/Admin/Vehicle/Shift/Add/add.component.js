...
var AddComponent = (function () {
    ...
    AddComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            ...
            var shiftAddBreadCrumb = breadC.filter(function (filter) {
                return filter.pageName === 'ShiftAddPage';
            })[0];
            console.log("BreadC -----", breadC);
            console.log("shiftAddBreadCrumb ---------", shiftAddBreadCrumb);
            _this.breadcrumbs = [];
            _this.breadcrumbs = shiftAddBreadCrumb.items;
    ...
    AddComponent.prototype.onSubmit = function (formRef) {
        ...
        this.service.postAdd(formData).subscribe(function (res) {
            ...
            if (res.isSuccess) {
                ...
                _this.router.navigate(["/admin/vehicle/shift"], { queryParams: { page: 1 } });
            }
        });
        // );
    };
