...
var DetailsComponent = (function () {
    ...
    DetailsComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.forEach(function (params) {
            ...
            _this.MilestoneId = params['id']; // (+) converts string 'id' to a number
            //let locale = params['locale'];
            _this.service.getById(_this.MilestoneId).subscribe(function (MilestoneDetails) {
                _this.MilestoneDetails = MilestoneDetails.result;
                console.log(_this.MilestoneDetails);
            });
        });
    };
    DetailsComponent.prototype.onSubmit = function (formRef) {
        this.service.postUpdate(this.MilestoneDetails).subscribe(function (MilestoneDetails) {
        });
        this.msgs = [];
