...
var RoleComponent = (function () {
    function RoleComponent(breadCrumbsService, service, route, router, logger) {
    ...
    RoleComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            ...
            var roleBreadCrumb = breadC.filter(function (filter) {
                return filter.pageName === 'RoleHomePage';
            })[0];
            console.log("BreadC -----", breadC);
            console.log("roleBreadCrumb ---------", roleBreadCrumb);
            _this.breadcrumbs = [];
            _this.breadcrumbs = roleBreadCrumb.items;
    ...
    RoleComponent.prototype.navigateDetails = function (id) {
