...
export class MilestoneEventComponent {
    //title = "MilestoneEvent Grid view";
    gridData = [];
    confInfo:any = {};
    cols = [];
    gridFilter = {};

    constructor(private service: MilestoneEventService, private router: Router, private logger: LoggerService) {
