...
export class AddComponent {
    ...
    constructor(private service: TestStageService, private router: Router, private route: ActivatedRoute) {
    ...
    onSubmit(formRef) {
        ...
        this.service.postAdd(formData).subscribe(res => {
            ...
            if (res.isSuccess) {
                ...
                this.router.navigate(["/vehicle/testStage"], { queryParams: { page: 1 } });
