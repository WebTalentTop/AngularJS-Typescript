...
var TenantComponent = (function () {
    function TenantComponent(service, router, logger) {
    ...
    TenantComponent.prototype.loadFreshDepartments = function (event) {
        var _this = this;
        setTimeout(function () {
    ...
    TenantComponent.prototype.getGridFilterValues = function (event) {
