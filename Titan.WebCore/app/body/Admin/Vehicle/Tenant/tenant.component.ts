import { TenantService } from '../../../../shared/services/tenant.services';
...
export class TenantComponent {
    ...
    constructor(private dataService: TenantService, private router: Router, private logger: LoggerService) {
