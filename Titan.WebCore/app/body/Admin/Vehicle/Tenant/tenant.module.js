...
var tenant_routes_1 = require("./tenant.routes");
var tenant_service_1 = require('../../../../shared/services/tenant.service');
var TenantModule = (function () {
    function TenantModule() {
    }
    TenantModule = __decorate([
        core_1.NgModule({
            imports: [common_1.CommonModule, primeng_1.DataTableModule, grid_module_1.GridModule, tenant_routes_1.default],
