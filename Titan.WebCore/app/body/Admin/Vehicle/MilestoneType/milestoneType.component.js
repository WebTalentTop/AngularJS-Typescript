...
var MilestoneTypeComponent = (function () {
    function MilestoneTypeComponent(breadCrumbsService, service, route, router, logger) {
    ...
    MilestoneTypeComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.queryParams.subscribe(function (params) {
            _this.added = params['page'];
            var breadC = _this.breadCrumbsService.getBreadCrumbs();
            var milestoneTypeBreadCrumb = breadC.filter(function (filter) {
                return filter.pageName === 'MilestoneTypeHomePage';
            })[0];
            console.log("BreadC -----", breadC);
            console.log("milestoneTypeBreadCrumb ---------", milestoneTypeBreadCrumb);
            _this.breadcrumbs = [];
            _this.breadcrumbs = milestoneTypeBreadCrumb.items;
    ...
    MilestoneTypeComponent.prototype.navigateDetails = function (id) {
        this.router.navigate(['admin/vehicle/milestoneType/details', id]);
    };
    MilestoneTypeComponent = __decorate([
        core_1.Component({
    ...
    return MilestoneTypeComponent;
}());
exports.MilestoneTypeComponent = MilestoneTypeComponent;
