...
var TitanRoleComponent = (function () {
    function TitanRoleComponent(breadCrumbsService, service, route, router, logger) {
    ...
    TitanRoleComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.queryParams.subscribe(function (params) {
            _this.added = params['page'];
            var breadC = _this.breadCrumbsService.getBreadCrumbs();
            var titanRoleBreadCrumb = breadC.filter(function (filter) {
                return filter.pageName === 'TitanRoleHomePage';
            })[0];
            console.log("BreadC -----", breadC);
            console.log("titanRoleBreadCrumb ---------", titanRoleBreadCrumb);
            _this.breadcrumbs = [];
            _this.breadcrumbs = titanRoleBreadCrumb.items;
    ...
    TitanRoleComponent.prototype.navigateDetails = function (id) {
        this.router.navigate(['admin/vehicle/titanRole/details', id]);
    };
    TitanRoleComponent = __decorate([
        core_1.Component({
            selector: 'titanRole-grid',
            templateUrl: 'app/body/Admin/Vehicle/TitanRole/titanRole.component.html'
        })
    ], TitanRoleComponent);
    return TitanRoleComponent;
}());
exports.TitanRoleComponent = TitanRoleComponent;
