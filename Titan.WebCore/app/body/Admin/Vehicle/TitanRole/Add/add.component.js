...
var AddComponent = (function () {
    ...
    AddComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            ...
            var titanRoleAddBreadCrumb = breadC.filter(function (filter) {
                return filter.pageName === 'TitanRoleAddPage';
            })[0];
            console.log("BreadC -----", breadC);
            console.log("titanRoleAddBreadCrumb ---------", titanRoleAddBreadCrumb);
            _this.breadcrumbs = [];
            _this.breadcrumbs = titanRoleAddBreadCrumb.items;
    ...
    AddComponent.prototype.onSubmit = function (formRef) {
        ...
        this.service.postAdd(formData).subscribe(function (res) {
            ...
            if (res.isSuccess) {
                ...
                _this.router.navigate(["/admin/vehicle/titanRole"], { queryParams: { page: 1 } });
            }
        });
        // );
    };
