...
var UnitsComponent = (function () {
    function UnitsComponent(breadCrumbsService, service, route, router, logger) {
    ...
    UnitsComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            ...
            var unitsBreadCrumb = breadC.filter(function (filter) {
                return filter.pageName === 'UnitsHomePage';
            })[0];
            console.log("BreadC -----", breadC);
            console.log("unitsBreadCrumb ---------", unitsBreadCrumb);
            _this.breadcrumbs = [];
            _this.breadcrumbs = unitsBreadCrumb.items;
    ...
    UnitsComponent.prototype.navigateDetails = function (id) {
