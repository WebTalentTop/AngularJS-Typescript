...
var AddComponent = (function () {
    ...
    AddComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            ...
            var unitsAddBreadCrumb = breadC.filter(function (filter) {
                return filter.pageName === 'UnitsAddPage';
            })[0];
            console.log("BreadC -----", breadC);
            console.log("unitsAddBreadCrumb ---------", unitsAddBreadCrumb);
            _this.breadcrumbs = [];
            _this.breadcrumbs = unitsAddBreadCrumb.items;
    ...
    AddComponent.prototype.onSubmit = function (formRef) {
        ...
        this.service.postAdd(formData).subscribe(function (res) {
            ...
            if (res.isSuccess) {
                ...
                _this.router.navigate(["/admin/vehicle/units"], { queryParams: { page: 1 } });
            }
        });
        // );
    };
