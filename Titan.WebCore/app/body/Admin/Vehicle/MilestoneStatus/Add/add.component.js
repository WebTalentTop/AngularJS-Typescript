...
var AddComponent = (function () {
    ...
    AddComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            ...
            var milestoneStatusAddBreadCrumb = breadC.filter(function (filter) {
                return filter.pageName === 'MilestoneStatusAddPage';
            })[0];
            console.log("BreadC -----", breadC);
            console.log("milestoneStatusAddBreadCrumb ---------", milestoneStatusAddBreadCrumb);
            _this.breadcrumbs = [];
            _this.breadcrumbs = milestoneStatusAddBreadCrumb.items;
    ...
    AddComponent.prototype.onSubmit = function (formRef) {
        ...
        this.service.postAdd(formData).subscribe(function (res) {
            ...
            if (res.isSuccess) {
                ...
                _this.router.navigate(["/admin/vehicle/milestoneStatus"], { queryParams: { page: 1 } });
            }
        });
        // );
    };
