...
export class AddComponent {
    ...
    constructor(private service: MilestoneStatusService, private router: Router, private route: ActivatedRoute) {
    ...
    onSubmit(formRef) {
        ...
        this.service.postAdd(formData).subscribe(res => {
            ...
            if (res.isSuccess) {
                ...
                this.router.navigate(["/vehicle/milestoneStatus"], { queryParams: { page: 1 } });
