...
var AccessComponent = (function () {
    function AccessComponent(breadCrumbsService, service, route, router, logger) {
    ...
    AccessComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            ...
            var accessBreadCrumb = breadC.filter(function (filter) {
                return filter.pageName === 'AccessHomePage';
            })[0];
            // console.log("BreadC -----", breadC);
            // console.log("accessBreadCrumb ---------", accessBreadCrumb);
            _this.breadcrumbs = [];
            _this.breadcrumbs = accessBreadCrumb.items;
    ...
    AccessComponent.prototype.navigateDetails = function (id) {
        this.router.navigate(['/admin/vehicle/access/details', id]);
    };
    AccessComponent = __decorate([
        core_1.Component({
            selector: 'access-grid',
            templateUrl: 'app/body/Admin/Vehicle/Access/access.component.html'
        })
    ], AccessComponent);
