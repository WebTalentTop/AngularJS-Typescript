...
var DetailsComponent = (function () {
    ...
    DetailsComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.forEach(function (params) {
            ...
            _this.ContactId = params['id']; // (+) converts string 'id' to a number
            //let locale = params['locale'];
            _this.service.getById(_this.ContactId).subscribe(function (ContactDetails) {
                _this.ContactDetails = ContactDetails.result;
                console.log(_this.ContactDetails);
            });
        });
    };
    DetailsComponent.prototype.onSubmit = function (formRef) {
        this.service.postUpdate(this.ContactDetails).subscribe(function (ContactDetails) {
        });
        this.msgs = [];
