...
export class AddComponent {
    ...
    constructor(private service: TestVerificationMethodService, private router: Router, private route: ActivatedRoute) {
    ...
    onSubmit(formRef) {
        ...
        this.service.postAdd(formData).subscribe(res => {
            ...
            if (res.isSuccess) {
                ...
                this.router.navigate(["/vehicle/testVerificationMethod"], { queryParams: { page: 1 } });
