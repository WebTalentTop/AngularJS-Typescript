...
var SensorTypeComponent = (function () {
    function SensorTypeComponent(breadCrumbsService, service, route, router, logger) {
    ...
    SensorTypeComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            ...
            var sensorTypeBreadCrumb = breadC.filter(function (filter) {
                return filter.pageName === 'SensorTypeHomePage';
            })[0];
            console.log("BreadC -----", breadC);
            console.log("sensorTypeBreadCrumb ---------", sensorTypeBreadCrumb);
            _this.breadcrumbs = [];
            _this.breadcrumbs = sensorTypeBreadCrumb.items;
    ...
    SensorTypeComponent.prototype.navigateDetails = function (id) {
        this.router.navigate(['admin/vehicle/sensorType/details', id]);
    };
    SensorTypeComponent = __decorate([
        core_1.Component({
...
exports.SensorTypeComponent = SensorTypeComponent;
