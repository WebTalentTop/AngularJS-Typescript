...
export class VehicleTypeComponent {
    ...
    msgs: Message[] = [];
    added: any;
    constructor(private breadCrumbsService: BreadCrumbsService,private service: VehicleTypeService, private route: ActivatedRoute, private router: Router, private logger: LoggerService) {
    ...
    ngOnInit() {
        ...
        this.route.queryParams.subscribe(params => {
            ...
            let vehicleTypeBreadCrumb = breadC.filter(filter =>
                filter.pageName === 'VehicleTypeHomePage'
            )[0];

            console.log("BreadC -----", breadC);
            console.log("vehicleTypeBreadCrumb ---------", vehicleTypeBreadCrumb);
            this.breadcrumbs = [];
            this.breadcrumbs = vehicleTypeBreadCrumb.items;
    ...
    navigateDetails(id:string){
        this.router.navigate(['vehicle/vehicleType/details', id]);
    }
}