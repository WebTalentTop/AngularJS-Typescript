...
export class AddComponent {
    ...
    ngOnInit() {
        this.route.queryParams.subscribe(params => {
            ...
            let vehicleTypeAddBreadCrumb = breadC.filter(filter =>
                filter.pageName === 'VehicleTypeAddPage'
            )[0];

            console.log("BreadC -----", breadC);
            console.log("vehicleTypeAddBreadCrumb ---------", vehicleTypeAddBreadCrumb);
            this.breadcrumbs = [];
            this.breadcrumbs = vehicleTypeAddBreadCrumb.items;
    ...
    onSubmit(formRef) {
        ...
        this.service.postAdd(formData).subscribe(res => {
            ...
            if (res.isSuccess) {
                ...
                this.router.navigate(["/admin/vehicle/vehicleType"], { queryParams: { page: 1 } });
