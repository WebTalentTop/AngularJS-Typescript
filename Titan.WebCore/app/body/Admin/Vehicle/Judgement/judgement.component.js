...
var JudgementComponent = (function () {
    function JudgementComponent(breadCrumbsService, service, route, router, logger) {
    ...
    JudgementComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            ...
            var judgementBreadCrumb = breadC.filter(function (filter) {
                return filter.pageName === 'JudgementHomePage';
            })[0];
            console.log("BreadC -----", breadC);
            console.log("judgementBreadCrumb ---------", judgementBreadCrumb);
            _this.breadcrumbs = [];
            _this.breadcrumbs = judgementBreadCrumb.items;
    ...
    JudgementComponent.prototype.navigateDetails = function (id) {
