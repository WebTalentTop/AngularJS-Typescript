...
var AddComponent = (function () {
    ...
    AddComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            ...
            var platformAddBreadCrumb = breadC.filter(function (filter) {
                return filter.pageName === 'PlatformAddPage';
            })[0];
            console.log("BreadC -----", breadC);
            console.log("platformAddBreadCrumb ---------", platformAddBreadCrumb);
            _this.breadcrumbs = [];
            _this.breadcrumbs = platformAddBreadCrumb.items;
    ...
    AddComponent.prototype.onSubmit = function (formRef) {
        ...
        this.service.postAdd(formData).subscribe(function (res) {
            ...
            if (res.isSuccess) {
                ...
                _this.router.navigate(["/admin/vehicle/platform"], { queryParams: { page: 1 } });
            }
        });
        // );
    };
