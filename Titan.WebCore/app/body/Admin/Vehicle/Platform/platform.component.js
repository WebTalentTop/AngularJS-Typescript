...
var PlatformComponent = (function () {
    function PlatformComponent(breadCrumbsService, service, route, router, logger) {
    ...
    PlatformComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            ...
            var platformBreadCrumb = breadC.filter(function (filter) {
                return filter.pageName === 'PlatformHomePage';
            })[0];
            console.log("BreadC -----", breadC);
            console.log("platformBreadCrumb ---------", platformBreadCrumb);
            _this.breadcrumbs = [];
            _this.breadcrumbs = platformBreadCrumb.items;
    ...
    PlatformComponent.prototype.navigateDetails = function (id) {
