...
export class AddComponent {
    ...
    constructor(private service: StepFrequencyService, private router: Router, private route: ActivatedRoute) {
    ...
    onSubmit(formRef) {
        ...
        this.service.postAdd(formData).subscribe(res => {
            ...
            if (res.isSuccess) {
                ...
                this.router.navigate(["/vehicle/stepFrequency"], { queryParams: { page: 1 } });
