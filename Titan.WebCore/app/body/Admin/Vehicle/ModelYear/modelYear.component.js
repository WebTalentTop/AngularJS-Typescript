...
var ModelYearComponent = (function () {
    function ModelYearComponent(breadCrumbsService, service, route, router, logger) {
    ...
    ModelYearComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.queryParams.subscribe(function (params) {
            _this.added = params['page'];
            var breadC = _this.breadCrumbsService.getBreadCrumbs();
            var modelYearBreadCrumb = breadC.filter(function (filter) {
                return filter.pageName === 'ModelYearHomePage';
            })[0];
            console.log("BreadC -----", breadC);
            console.log("modelYearBreadCrumb ---------", modelYearBreadCrumb);
            _this.breadcrumbs = [];
            _this.breadcrumbs = modelYearBreadCrumb.items;
    ...
    ModelYearComponent.prototype.navigateDetails = function (id) {
        this.router.navigate(['admin/vehicle/modelYear/details', id]);
    };
    ModelYearComponent = __decorate([
        core_1.Component({
            selector: 'modelYear-grid',
            templateUrl: 'app/body/Admin/Vehicle/ModelYear/modelYear.component.html'
        })
    ], ModelYearComponent);
    return ModelYearComponent;
}());
exports.ModelYearComponent = ModelYearComponent;
