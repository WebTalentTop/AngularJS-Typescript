...
@Component({
    selector: 'edit',
    templateUrl: 'app/body/Admin/Vehicle/TestStatus/Edit/edit.component.html'
})
export class EditComponent {
    title = "TestStatus Edit";
    ...
    constructor(private route: ActivatedRoute, private service: TestStatusService) {
