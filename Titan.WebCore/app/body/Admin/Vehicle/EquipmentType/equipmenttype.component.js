...
var EquipmentTypeComponent = (function () {
    function EquipmentTypeComponent(service) {
    ...
    EquipmentTypeComponent.prototype.loadFreshDepartments = function (event) {
        var _this = this;
        setTimeout(function () {
    ...
    EquipmentTypeComponent.prototype.getGridFilterValues = function (event) {
