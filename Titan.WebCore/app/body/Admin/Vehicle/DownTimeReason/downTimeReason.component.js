...
var DownTimeReasonComponent = (function () {
    function DownTimeReasonComponent(breadCrumbsService, service, route, router, logger) {
    ...
    DownTimeReasonComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.queryParams.subscribe(function (params) {
            _this.added = params['page'];
            var breadC = _this.breadCrumbsService.getBreadCrumbs();
            var downTimeReasonBreadCrumb = breadC.filter(function (filter) {
                return filter.pageName === 'DownTimeReasonHomePage';
            })[0];
            console.log("BreadC -----", breadC);
            console.log("downTimeReasonBreadCrumb ---------", downTimeReasonBreadCrumb);
            _this.breadcrumbs = [];
            _this.breadcrumbs = downTimeReasonBreadCrumb.items;
    ...
    DownTimeReasonComponent.prototype.navigateDetails = function (id) {
        this.router.navigate(['/admin/vehicle/downTimeReason/details', id]);
    };
    DownTimeReasonComponent = __decorate([
        core_1.Component({
            selector: 'downTimeReason-grid',
            templateUrl: 'app/body/Admin/Vehicle/DownTimeReason/downTimeReason.component.html'
        })
    ], DownTimeReasonComponent);
    return DownTimeReasonComponent;
}());
exports.DownTimeReasonComponent = DownTimeReasonComponent;
