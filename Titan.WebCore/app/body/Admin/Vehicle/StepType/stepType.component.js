...
var StepTypeComponent = (function () {
    function StepTypeComponent(breadCrumbsService, service, route, router, logger) {
    ...
    StepTypeComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.queryParams.subscribe(function (params) {
            _this.added = params['page'];
            var breadC = _this.breadCrumbsService.getBreadCrumbs();
            var stepTypeBreadCrumb = breadC.filter(function (filter) {
                return filter.pageName === 'StepTypeHomePage';
            })[0];
            console.log("BreadC -----", breadC);
            console.log("stepTypeBreadCrumb ---------", stepTypeBreadCrumb);
            _this.breadcrumbs = [];
            _this.breadcrumbs = stepTypeBreadCrumb.items;
    ...
    StepTypeComponent.prototype.navigateDetails = function (id) {
        this.router.navigate(['admin/vehicle/stepType/details', id]);
    };
    StepTypeComponent = __decorate([
        core_1.Component({
...
exports.StepTypeComponent = StepTypeComponent;
