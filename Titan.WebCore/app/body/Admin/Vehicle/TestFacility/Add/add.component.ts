...
@Component({
    selector: 'add-testfacility',
    styleUrls: ['app/body/Admin/Vehicle/TestFacility/Add/add.component.css'], 
    templateUrl: 'app/body/Admin/Vehicle/TestFacility/Add/add.component.html'
})
