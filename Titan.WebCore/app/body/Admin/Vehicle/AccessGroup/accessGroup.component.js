...
var AccessGroupComponent = (function () {
    function AccessGroupComponent(breadCrumbsService, service, route, router, logger) {
    ...
    AccessGroupComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.queryParams.subscribe(function (params) {
            _this.added = params['page'];
            var breadC = _this.breadCrumbsService.getBreadCrumbs();
            var accessGroupBreadCrumb = breadC.filter(function (filter) {
                return filter.pageName === 'AccessGroupHomePage';
            })[0];
            console.log("BreadC -----", breadC);
            console.log("accessGroupBreadCrumb ---------", accessGroupBreadCrumb);
            _this.breadcrumbs = [];
            _this.breadcrumbs = accessGroupBreadCrumb.items;
