...
@NgModule({
    imports: [CommonModule,RouterModule, DataTableModule,DialogModule, InputTextModule,DropdownModule, InputTextareaModule, TabViewModule,GridModule,equipmentRoutes],
