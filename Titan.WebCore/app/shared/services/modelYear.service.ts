...
import { ModelYearApiUrl} from './apiUrlConst/ModelYearApiUrls';
...
export class ModelYearService {
    ...
    postGridDataFilter(filterBody): Observable<any> {
        ...
        return this.http.post(`${ModelYearApiUrl.gridApiUrl}`, filterBody, { headers: this.headers })
            .map(this.getJson);
        //this.checkErrors)
        //.catch(err => Observable.throw(err))
        //.map(this.getJson);
    ...
    postAdd(filterBody): Observable<any> {
        console.log("-------- Post Customers FilterBody --------", filterBody);
        return this.http.post(`${ModelYearApiUrl.postCreatedUrl}`, filterBody, { headers: this.headers })
    ...
    postUpdate(filterBody): Observable<any> {
        console.log("-------- Post Customers FilterBody --------", filterBody);
        return this.http.put(`${ModelYearApiUrl.postUpdateUrl}`, filterBody, { headers: this.headers })
            .map(this.getJson)
    ...
    getById(id): Observable<any> {
        return this.http.get(`${ModelYearApiUrl.getByIdUrl}/${id}`, { headers: this.headers })
            .map(this.getJson)
            ;
        //.catch(err => Observable.throw(err))
        //.map(this.getJson);
