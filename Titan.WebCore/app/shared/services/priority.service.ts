...
import { PriorityApiUrl} from './apiUrlConst/PriorityApiUrls';
...
export class PriorityService {
    ...
    postGridData(): Observable<any> {
        return this.http.post(`${PriorityApiUrl.gridApiUrl}`, this.body, { headers: this.headers })
            .map(this.getJson);
        //this.checkErrors)
    ...
    postGridDataFilter(filterBody): Observable<any> {
        ...
        return this.http.post(`${PriorityApiUrl.gridApiUrl}`, filterBody, { headers: this.headers })
            .map(this.getJson);
        //this.checkErrors)
        //.catch(err => Observable.throw(err))
        //.map(this.getJson);
    ...
    postUpdate(filterBody): Observable<any> {
        console.log("-------- Post Customers FilterBody --------", filterBody);
        return this.http.put(`${PriorityApiUrl.postUpdateUrl}`, filterBody, { headers: this.headers })
            .map(this.getJson)
