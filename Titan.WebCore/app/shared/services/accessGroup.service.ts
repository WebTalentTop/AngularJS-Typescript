...
import { AccessGroupApiUrl} from './apiUrlConst/AccessGroupApiUrls';
...
export class AccessGroupService {
    ...
    postGridData(): Observable<any> {
        return this.http.post(`${AccessGroupApiUrl.gridApiUrl}`, this.body, { headers: this.headers })
            .map(this.getJson);
        //this.checkErrors)
    ...
    postGridDataFilter(filterBody): Observable<any> {
        ...
        return this.http.post(`${AccessGroupApiUrl.gridApiUrl}`, filterBody, { headers: this.headers })
            .map(this.getJson);
        //this.checkErrors)
        //.catch(err => Observable.throw(err))
        //.map(this.getJson);
    ...
    postUpdate(filterBody): Observable<any> {
        console.log("-------- Post Customers FilterBody --------", filterBody);
        return this.http.put(`${AccessGroupApiUrl.postUpdateUrl}`, filterBody, { headers: this.headers })
            .map(this.getJson)
    ...
    getById(id): Observable<any> {
        return this.http.get(`${AccessGroupApiUrl.getByIdUrl}/${id}`, { headers: this.headers })
            .map(this.getJson)
            ;
        //.catch(err => Observable.throw(err))
        //.map(this.getJson);
