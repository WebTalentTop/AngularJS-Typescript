...
import { MarketApiUrl} from './apiUrlConst/MarketApiUrls';
...
export class MarketService {
    ...
    postGridData(): Observable<any> {
        return this.http.post(`${MarketApiUrl.gridApiUrl}`, this.body, { headers: this.headers })
            .map(this.getJson);
        //this.checkErrors)
        //.catch(err => Observable.throw(err))
        //.map(this.getJson);
    ...
    postGridDataFilter(filterBody): Observable<any> {
        ...
        return this.http.post(`${MarketApiUrl.gridApiUrl}`, filterBody, { headers: this.headers })
            .map(this.getJson);
        //this.checkErrors)
        //.catch(err => Observable.throw(err))
        //.map(this.getJson);
    ...
    postAdd(filterBody): Observable<any> {
        console.log("-------- Post Customers FilterBody --------", filterBody);
        return this.http.post(`${MarketApiUrl.postCreatedUrl}`, filterBody, { headers: this.headers })
    ...
    postUpdate(filterBody): Observable<any> {
        console.log("-------- Post Customers FilterBody --------", filterBody);
        return this.http.put(`${MarketApiUrl.postUpdateUrl}`, filterBody, { headers: this.headers })
            .map(this.getJson)
    ...
    getById(id): Observable<any> {
        return this.http.get(`${MarketApiUrl.getByIdUrl}/${id}`, { headers: this.headers })
            .map(this.getJson)
            ;
        //.catch(err => Observable.throw(err))
        //.map(this.getJson);
