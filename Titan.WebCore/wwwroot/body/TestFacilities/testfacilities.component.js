...
var TestFacilitiesComponent = (function () {
    function TestFacilitiesComponent(dataService) {
        this.dataService = dataService;
        this.title = "Test Facilities";
        this.gridData = [];
        this.confInfo = {};
        this.cols = [];
        this.gridFilter = {};
    ...
    TestFacilitiesComponent.prototype.loadFreshDepartments = function (event) {
        var _this = this;
        setTimeout(function () {
    ...
    TestFacilitiesComponent.prototype.getGridFilterValues = function (event) {
...
//# sourceMappingURL=testfacilities.component.js.map