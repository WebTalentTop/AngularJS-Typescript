...
var FrameNumberComponent = (function () {
    function FrameNumberComponent(dataService) {
        this.dataService = dataService;
        this.title = "Frame Number view";
        this.gridData = [];
        this.confInfo = {};
        this.cols = [];
        this.gridFilter = {};
    }
    FrameNumberComponent.prototype.ngOnInit = function () {
        var _this = this;
        var resData;
    ...
    FrameNumberComponent.prototype.loadFreshDepartments = function (event) {
        var _this = this;
        setTimeout(function () {
    ...
    FrameNumberComponent.prototype.getGridFilterValues = function (event) {
    ...
    FrameNumberComponent = __decorate([
        core_1.Component({
            selector: 'Frame-Number',
            templateUrl: 'app/body/Admin/Vehicle/FrameNumber/framenumber.component.html'
        }), 
        __metadata('design:paramtypes', [data_services_1.DataService])
    ], FrameNumberComponent);
    return FrameNumberComponent;
}());
exports.FrameNumberComponent = FrameNumberComponent;
//# sourceMappingURL=framenumber.component.js.map