...
var EngineCodeComponent = (function () {
    function EngineCodeComponent(dataService) {
        this.dataService = dataService;
        this.title = "EngineCode View";
        this.gridData = [];
        this.confInfo = {};
        this.cols = [];
        this.gridFilter = {};
    ...
    EngineCodeComponent.prototype.loadFreshDepartments = function (event) {
        var _this = this;
        setTimeout(function () {
    ...
    EngineCodeComponent.prototype.getGridFilterValues = function (event) {
...
//# sourceMappingURL=engineCode.component.js.map