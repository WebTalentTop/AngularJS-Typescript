...
var GradeComponent = (function () {
    function GradeComponent(dataService) {
        this.dataService = dataService;
        this.title = "Grade view";
        this.gridData = [];
        this.confInfo = {};
        this.cols = [];
        this.gridFilter = {};
    ...
    GradeComponent.prototype.loadFreshDepartments = function (event) {
        var _this = this;
        setTimeout(function () {
    ...
    GradeComponent.prototype.getGridFilterValues = function (event) {
