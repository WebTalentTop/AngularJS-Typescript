...
var VehicleComponent = (function () {
    function VehicleComponent(dataService) {
        this.dataService = dataService;
        this.title = "Vehicle view";
        this.gridData = [];
        this.confInfo = {};
        this.cols = [];
        this.gridFilter = {};
    ...
    VehicleComponent.prototype.loadFreshDepartments = function (event) {
        var _this = this;
        setTimeout(function () {
    ...
    VehicleComponent.prototype.getGridFilterValues = function (event) {
