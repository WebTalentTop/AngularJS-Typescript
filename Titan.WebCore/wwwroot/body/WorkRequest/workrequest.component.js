...
var WorkRequestComponent = (function () {
    function WorkRequestComponent(dataService) {
    ...
    WorkRequestComponent.prototype.loadFreshDepartments = function (event) {
        var _this = this;
        setTimeout(function () {
    ...
    WorkRequestComponent.prototype.getGridFilterValues = function (event) {
