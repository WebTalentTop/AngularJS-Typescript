...
var TestCatalogComponent = (function () {
    function TestCatalogComponent(dataService) {
        this.dataService = dataService;
        this.title = "Test Catalog";
        this.gridData = [];
        this.confInfo = {};
        this.cols = [];
        this.gridFilter = {};
    }
    TestCatalogComponent.prototype.ngOnInit = function () {
        var _this = this;
        var resData;
    ...
    TestCatalogComponent.prototype.loadFreshDepartments = function (event) {
        var _this = this;
        setTimeout(function () {
    ...
    TestCatalogComponent.prototype.getGridFilterValues = function (event) {
    ...
    TestCatalogComponent = __decorate([
        core_1.Component({
    ...
    return TestCatalogComponent;
}());
exports.TestCatalogComponent = TestCatalogComponent;
//# sourceMappingURL=testcatalog.component.js.map