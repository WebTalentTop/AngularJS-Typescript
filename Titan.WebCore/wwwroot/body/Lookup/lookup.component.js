...
var LookupComponent = (function () {
    function LookupComponent(dataService) {
        this.dataService = dataService;
        this.title = "Lookup Grid";
        this.gridData = [];
        this.confInfo = {};
        this.cols = [];
        this.gridFilter = {};
    ...
    LookupComponent.prototype.loadFreshDepartments = function (event) {
        var _this = this;
        setTimeout(function () {
    ...
    LookupComponent.prototype.getGridFilterValues = function (event) {
