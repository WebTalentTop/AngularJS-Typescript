/// <binding AfterBuild='copy-@types, copy-all, copy-dev-prime-res, copy-front-dev-only' />
/*
...
gulp.task("prepod-deployment-package", ['copy-preprodlocation', 'css', 'html', 'sourceMap', 'ts']);
...
gulp.task("copy-dev-prime-res", ['NMprimeResources', 'primeResources']);
