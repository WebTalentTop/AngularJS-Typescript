declare module GcSpread.Sheets{
    ...
    /**
     * Gets the Spread instance by the host element.
     * @param {HTMLElement} host The host element.
     * @returns {GcSpread.Sheets.Spread} The Spread instance.
     */
    function findControl(host: HTMLElement): Spread;
    /**
    ...
    export interface IActiveSheetChangedEventArgs extends IEventArgs{
        oldSheet: Sheet;
        newSheet: Sheet;
    }


    export interface IActiveSheetChangingEventArgs extends IEventArgs{
        oldSheet: Sheet;
        newSheet: Sheet;
        cancel: boolean;
    }
    ...
    export interface IButtonClickedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        row: number;
        col: number;
    ...
    export interface ICellChangedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        row: number;
        col: number;
    ...
    export interface ICellClickEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        sheetArea: SheetArea;
        row: number;
    ...
    export interface ICellDoubleClickEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        sheetArea: SheetArea;
        row: number;
    ...
    export interface IClipboardChangedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        copyData: string;
    }
    ...
    export interface IClipboardChangingEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        copyData: string;
        cancel: boolean;
    ...
    export interface IClipboardPastedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        cellRange: Range;
    ...
    export interface IClipboardPastingEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        cellRange: Range;
        pasteOption: ClipboardPasteOptions;
    ...
    export interface IColumnChangedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        col: number;
        sheetArea: SheetArea;
    ...
    export interface IColumnWidthChangedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        colList: any[];
        header: boolean;
    ...
    export interface IColumnWidthChangingEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        colList: any[];
        header: boolean;
    ...
    export interface ICommentChangedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        comment: Comment;
        propertyName: string;
    ...
    export interface ICommentRemovedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        comment: any;
    }
    ...
    export interface ICommentRemovingEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        comment: any;
        cancel: boolean;
    ...
    export interface ICustomFloatingObjectLoadedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        customFloatingObject: any;
        element: HTMLElement;
    }
    ...
    export interface IDragDropBlockCompletedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        fromRow: number;
        fromCol: number;
        ...
        copy: boolean;
        insert: boolean;
        copyOption: CopyToOption;
    }


    export interface IDragDropBlockEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        fromRow: number;
        fromCol: number;
    ...
    export interface IDragFillBlockCompletedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        fillRange: Range;
    ...
    export interface IDragFillBlockEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        fillRange: Range;
        autoFillType: AutoFillType;
    ...
    export interface IEditChangeEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        row: number;
        col: number;
    ...
    export interface IEditEndedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        row: number;
        col: number;
    ...
    export interface IEditEndingEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        row: number;
        col: number;
    ...
    export interface IEditorStatusChangedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
    ...
    export interface IEditStartingEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        row: number;
        col: number;
    ...
    export interface IEnterCellEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        row: number;
        col: number;
    ...
    export interface IFloatingObjectChangedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        floatingObject: any;
        propertyName: string;
    ...
    export interface IFloatingObjectRemovedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        floatingObject: any;
    }
    ...
    export interface IFloatingObjectRemovingEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        floatingObject: any;
        cancel: boolean;
    ...
    export interface IFloatingObjectSelectionChangedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        floatingObject: any;
    }
    ...
    export interface IInvalidOperationEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
    ...
    export interface ILeaveCellEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        row: number;
        col: number;
    ...
    export interface ILeftColumnChangedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        oldLeftCol: number;
        newLeftCol: number;
    ...
    export interface IPictureChangedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        picture: any;
        propertyName: string;
    ...
    export interface IPictureSelectionChangedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        picture: any;
    }
    ...
    export interface IProtectionOption{
    ...
    export interface IRangeChangedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        row: number;
        column: number;
    ...
    export interface IRangeFilteredEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        col: number;
        filterValues: any[];
    ...
    export interface IRangeFilteringEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        col: number;
        filterValues: any[];
    ...
    export interface IRangeGroupStateChangedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        isRowGroup: boolean;
        index: number;
    ...
    export interface IRangeGroupStateChangingEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        isRowGroup: boolean;
        index: number;
    ...
    export interface IRangeSortedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        col: number;
        ascending: boolean;
    ...
    export interface IRangeSortingEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        col: number;
        ascending: boolean;
    ...
    export interface IRowChangedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        row: number;
        sheetArea: SheetArea;
    ...
    export interface IRowHeightChangedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        rowList: any[];
        header: boolean;
    ...
    export interface IRowHeightChangingEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        rowList: any[];
        header: boolean;
    ...
    export interface ISelectionChangedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
    }


    export interface ISelectionChangingEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        oldSelections: any[];
        newSelections: any[];
    ...
    export interface ISheetNameChangedEventArgs extends IEventArgs{
        sheet: Sheet;
        oldValue: string;
        newValue: string;
    }
    ...
    export interface ISheetNameChangingEventArgs extends IEventArgs{
        sheet: Sheet;
        oldValue: string;
        newValue: string;
        cancel: boolean;
    ...
    export interface ISheetTabClickEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
    ...
    export interface ISheetTabDoubleClickEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        sheetTabIndex: number;
    }
    ...
    export interface ISlicerChangedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        slicer: Slicer;
        propertyName: string;
    ...
    export interface ISparklineChangedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        sparkline: any;
    }
    ...
    export interface ITableFilteredEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        table: SheetTable;
        tableCol: number;
    ...
    export interface ITableFilteringEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        table: SheetTable;
        tableCol: number;
    ...
    export interface ITopRowChangedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        oldTopRow: number;
        newTopRow: number;
    ...
    export interface ITouchToolStripOpeningEventArgs extends IEventArgs{
        x: number;
        y: number;
        handled: boolean;
    }
    ...
    export interface IUserFormulaEnteredEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        row: number;
        col: number;
    ...
    export interface IUserZoomingEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
    ...
    export interface IValidationErrorEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        row: number;
        col: number;
    ...
    export interface IValueChangedEventArgs extends IEventArgs{
        sheet: Sheet;
        sheetName: string;
        row: number;
        col: number;
    ...
    export enum CommentState{
        ...
        Active = 1,
        /**
         *Specifies that the comment is in an edit state.
         */
        Edit = 2,
        /**
    ...
    export enum PrintVisibilityType{
        /**
         * Inherits the setting from the Sheet class.
         */
        Inherit = 0,
        /**
         * Hides the area.
    ...
    /**
     * Defines the reason the slicer data changed.
     * @enum {number}
     */
    export enum SlicerDataChangeReason{
        /**
         * Specifies that the slicer data change reason is data modified.
         */
        DataModified = 0,
        /**
         * Specifies that the slicer data change reason is data added.
         */
        DataAdded = 1,
        /**
         * Specifies that the slicer data change reason is data removed.
         */
        DataRemoved = 2
    }
    ...
    export class AverageCondition{
         ...
         * @type {Array.<GcSpread.Sheets.Range>}
         */
        ranges: Range[];
    ...
    export class ButtonCellType extends TextCellType{
        /**
    ...
    export class CellValueCondition{
         ...
         * @param {number} baseRow The base row index for evaluation.
         * @param {number} baseColumn The base column index for evaluation.
         * @param {boolean} isArrayFormula Indicates whether it is an array formula.
         * @returns {object} The expected value.
         */
    ...
    export class CellValueRule extends ConditionRuleBase{
        ...
        createCondition(): any;
        /**
         * Specifies whether the rule is a formula.
    ...
    export class CheckBoxCellType extends TextCellType{
        /**
    ...
    export class ColumnHeaderCellType extends BaseCellType{
        /**
    ...
    export class ComboBoxCellType extends BaseCellType{
        /**
         ...
         * @returns {number} The maximum item count of the drop-down list per page.
         */
    ...
    export class CultureInfo{
        ...
        pmDesignator: any;
        /**
         * Specifies the standard date formatter for "R" and "r".
         * @type {string}
         */
        rfc1123Pattern: any;
        /**
        ...
        /**
         * Specifies the standard date formatter for "s".
         * @type {string}
         */
        sortableDateTimePattern: any;
        /**
         * Specifies the standard date formatter for "u".
         * @type {string}
         */
    ...
    export class CustomCellType extends BaseCellType{
        /**
    ...
    export class DateCondition{
         ...
         */
        getExpectedDateTime(evaluator: any, baseRow: number, baseColumn: number): any;
    }
    ...
    export class Events{
         ...
         * @name GcSpread.Sheets.Sheet#CommentRemoved
         * @event
         * @param {GcSpread.Sheets.Sheet} sheet The sheet that triggered the event.
         * @param {string} sheetName The sheet's name.
         * @param {GcSpread.Sheets.Comment} comment The comment has been removed.
         */
        static CommentRemoved: any;
        /**
         * Occurs when the user is removing any comment.
         * @name GcSpread.Sheets.Sheet#CommentRemoving
         * @event
         * @param {GcSpread.Sheets.Sheet} sheet The sheet that triggered the event.
         * @param {string} sheetName The sheet's name.
         * @param {GcSpread.Sheets.Comment} comment The comment is being removed.
         * @param {boolean} cancel A value that indicates whether the operation should be canceled.
         */
        static CommentRemoving: any;
        /**
         ...
         * @name GcSpread.Sheets.Sheet#FloatingObjectRemoved
         * @event
         * @param {GcSpread.Sheets.Sheet} sheet The sheet that triggered the event.
         * @param {string} sheetName The sheet's name.
         * @param {GcSpread.Sheets.FloatingObject} floatingObject The floating object has been removed.
         */
        static FloatingObjectRemoved: any;
        /**
         * Occurs when the user is removing any floating object.
         * @name GcSpread.Sheets.Sheet#FloatingObjectRemoving
         * @event
         * @param {GcSpread.Sheets.Sheet} sheet The sheet that triggered the event.
         * @param {string} sheetName The sheet's name.
         * @param {GcSpread.Sheets.FloatingObject} floatingObject The floating object is being removed.
         * @param {boolean} cancel A value that indicates whether the operation should be canceled.
         */
        static FloatingObjectRemoving: any;
        /**
         ...
         * @param {GcSpread.Sheets.RangeChangedAction} action The type of action that raises the RangeChanged event.
         */
         ...
         * @name GcSpread.Sheets.Sheet#SlicerChanged
         * @event
         * @param {GcSpread.Sheets.Sheet} sheet The sheet that triggered the event.
         * @param {string} sheetName The sheet's name.
         * @param {GcSpread.Sheets.Slicer} slicer The slicer that triggered the event.
         * @param {string} propertyName The name of the slicer's property that has changed.
         */
        static SlicerChanged: any;
        /**
         ...
         * @param {GcSpread.Sheets.Sheet} sheet The sheet that triggered the event.
         * @param {string} sheetName The sheet's name.
         * @param {GcSpread.Sheets.SheetTable} table The table column to be automatically filtered.
    ...
    export class FloatingObject{
         ...
         * @returns {boolean} The setting for whether to disable moving the floating object.
         */
         ...
         * @returns {boolean} The setting for whether to disable resizing the floating object.
         */
         ...
         * @returns {Object} <c>true</c> if the position of the floating object is fixed; otherwise, <c>false</c>.
         */
         ...
         * @param {GcSpread.Sheets.Point} value The position of a floating object.
         * @returns {Object} The position of a floating object.
         */
        position(value?: Point): any;
        /**
    ...
    export class FormatConverter{
         ...
         */
        static IsNumber(value: any, numberFormatInfo?: any): boolean;
        /**
    ...
    export class GroupedItemIndexEnumerator{
        /**
         * Represents an enumerator for all group items from beginning to end.
    ...
    export class HyperLinkCellType extends TextCellType{
        /**
    ...
    export class ItemSlicer{
         ...
         * @class GcSpread.Sheets.ItemSlicer
         */
        constructor(name: string);
        /**
         * Gets or sets the caption name of the item slicer.
         * @param {string} value The caption name of the item slicer.
         * @returns {number} The caption name of the item slicer.
         */
        captionName(value?: string): any;
        /**
         * Gets or sets the column count of the item slicer.
         * @param {string} value The column count of the item slicer.
         * @returns {string} The column count of the item slicer.
         */
         ...
         * @returns {number} The height of the item slicer.
         */
        height(value?: number): any;
        /**
         * Gets or sets the item height of the item slicer.
         * @param {number} value The item height of the item slicer.
         * @returns {number} The item height of the item slicer.
         */
        itemHeight(value?: number): any;
        /**
         * Gets or sets the name of the item slicer.
         * @param {string} value The name of the item slicer.
         * @returns {string} The name of the item slicer.
         */
        name(value?: string): any;
        /**
         * Sets the slicer data and column name for the item slicer.
         * @param {GcSpread.Slicer.ISlicerData} value The slicer data of the item slicer.
         * @param {string} The column name of the item slicer.
         */
        setData(slicerData: GcSpread.Slicer.ISlicerData, columnName: string): void;
        /**
         * Gets or sets whether to show the header of the item slicer.
         * @param {boolean} value The show header setting of the item slicer.
         * @returns {boolean} The show header setting of the item slicer.
         */
         ...
         * @returns {boolean} The show no the data items setting of the slicer.
         */
         ...
         * @returns {boolean} The show no data items in last setting of the slicer.
         */
        showNoDataItemsInLast(value?: boolean): any;
        /**
         * Gets or sets the sort state of the item slicer.
         * @param {GcSpread.Sheets.SortState} value The sort state of the item slicer.
         * @returns {GcSpread.Sheets.SortState} The sort state of the item slicer.
         */
        sortState(value?: SortState): any;
        /**
         * Gets or sets the style of the item slicer.
         * @param {any} value The style of the item slicer.
         * @returns {any} The style of the item slicer.
         * @example
         ...
         * @returns {boolean} The setting for items with no data.
         */
         ...
         * @returns {number} The width of the item slicer.
         */
        width(value?: number): any;
    }
    ...
    export class PaperSize{
         ...
         * If there is 1 parameter, the parameter is kind which is a GcSpread.Sheets.PaperKind type;
         * If there is no parameter, the result is the same as the second mode and the kind option is GcSpread.Sheets.PaperKind.Letter.
         * @class
         * @param {Object} widthOrKind The width of the paper, in hundredths of an inch; or the kind of the paper and the type is GcSpread.Sheets.PaperKind.
         ...
         * @param {GcSpread.Sheets.PaperKind} kind The kind of the paper.
         ...
         */
        getPageSize(kind: PaperKind): PrintSize;
        /**
         * Gets or sets the height of the paper, in hundredths of an inch.
         * @param {number} value The height of the paper.
         * @returns {number} The height of the paper.
         */
        height(value?: number): any;
        /**
         * Gets or sets the kind of the paper.
         * @param {GcSpread.Sheets.PaperKind} value The kind of the paper.
         * @returns {GcSpread.Sheets.PaperKind} The kind of the paper.
         */
        kind(value?: PaperKind): any;
        /**
         * Gets or sets the width of the paper, in hundredths of an inch.
         * @param {number} value The width of the paper.
         * @returns {number} The width of the paper.
         */
        width(value?: number): any;
    }
    ...
    export class Picture extends FloatingObject{
         ...
         * @returns {Object} The backcolor of the picture.
         */
        backColor(value?: string): any;
        /**
    ...
    export class PrintInfo{
         ...
         * @returns {boolean} <c>true</c> if the column widths are adjusted to fit the longest text width for printing; otherwise, <c>false</c>. The default value is <c>false</c>.
         */
         ...
         * @returns {boolean} <c>true</c> if the row heights are adjusted to fit the tallest text height for printing; otherwise, <c>false</c>. The default value is <c>false</c>.
         */
         ...
         * @returns {boolean} <c>true</c> to print in black and white; otherwise, <c>false</c>. The default value is <c>false</c>.
         */
        blackAndWhite(value?: boolean): any;
        /**
         * Gets or sets how the printed page is centered.
         * @param {GcSpread.Sheets.PrintCentering} value How the printed page is centered.
         * @returns {GcSpread.Sheets.PrintCentering} A value that specifies how to center the printed page. The default value is GcSpread.Sheets.PrintCentering.None.
         */
        centering(value?: PrintCentering): any;
        /**
         ...
         * @returns {number} The column index of the last column to print when printing a cell range.
         */
         ...
         * @returns {number} The column index of the first column to print when printing a cell range.
         */
         ...
         * @returns {number} The page number to print on the first page. The default value is 1.
         */
         ...
         * @returns {number} The number of vertical pages to check.
         */
         ...
         * @returns {number} The number of horizontal pages to check.
         */
         ...
         * @returns {string} The text and format of the center footer for the printed pages of the report. The default value is an empty string, which means that no footers are printed.
         */
         ...
         * @returns {string}The image for the center portion of the printed footer. The default value is empty string, which means that no image is specified.
         */
         ...
         * @returns {string} The text and format of the left footer for the printed pages of the report. The default value is an empty string, which means that no footers are printed.
         */
         ...
         * @returns {string}The image for the left portion of the printed footer. The default value is empty string, which means that no image is specified.
         */
         ...
         * @returns {string} The text and format of the right footer for the printed pages of the report. The default value is an empty string, which means that no footers are printed.
         */
         ...
         * @returns {string} The image for the right portion of the printed footer. The default value is empty string, which means that no image is specified.
         */
         ...
         * @returns {string} The text and format of the center header for the printed pages of the report. The default value is an empty string, which means that no headers are printed.
         */
         ...
         * @returns {string} The image for the center portion of the printed header. The default value is empty string, which means that no image is specified.
         */
         ...
         * @returns {string} The text and format of the left header for the printed pages of the report. The default value is an empty string, which means that no headers are printed.
         */
         ...
         * @returns {string} The image for the left portion of the printed header. The default value is empty string, which means that no image is specified.
         */
         ...
         * @returns {string} The text and format of the right header for the printed pages of the report. The default value is an empty string, which means that no headers are printed.
         */
         ...
         * @returns {string}The image for the right portion of the printed header. The default value is empty string, which means that no image is specified.
         */
         ...
         * @returns {Object} The margins for printing.
         */
        margin(value?: PrintMargins): any;
        /**
         * Gets or sets the page orientation used for printing.
         * @param {GcSpread.Sheets.PrintPageOrientation} value The page orientation used for printing.
         * @returns {GcSpread.Sheets.PrintPageOrientation} A value that specifies the orientation for the printed page. The default value is GcSpread.Sheets.PrintPageOrientation.Portrait.
         */
        orientation(value?: PrintPageOrientation): any;
        /**
         * Gets or sets the order in which pages print.
         * @param {GcSpread.Sheets.PrintPageOrder} value The order in which pages print.
         * @returns {GcSpread.Sheets.PrintPageOrder} A value that specifies the order in which pages print. The default value is GcSpread.Sheets.PrintPageOrder.Auto.
         */
        pageOrder(value?: PrintPageOrder): any;
        /**
         ...
         * @returns {string} A string that provides page numbers or page ranges. The default value is an empty string.
         */
        pageRange(value?: string): any;
        /**
         * Gets or sets the paper size for printing.
         * @param {GcSpread.Sheets.PaperSize} value The paper size for printing.
         * @returns {GcSpread.Sheets.PaperSize} A GcSpread.Sheets.PaperSize object that represents the paper size for printing.
         */
        paperSize(value?: PaperSize): any;
        /**
         ...
         * @returns {number} The quality factor for printing. The default value is 2.
         */
         ...
         * @returns {number} The column index of the last column of a range of columns to print on the left of each page.
         */
         ...
         * @returns {number} The column index of the first column of a range of columns to print on the left of each page.
         */
         ...
         * @returns {number} The row index for the last row of a range of rows to print at the top of each page.
         */
         ...
         * @returns {number} The row index for the first row of a range of rows to print at the top of each page.
         */
         ...
         * @returns {number} The row index of the last row to print when printing a cell range.
         */
         ...
         * @returns {number} The row index of the first row to print when printing a cell range.
         */
         ...
         * @returns {boolean} <c>true</c> if an outline border is printed around the control; otherwise, <c>false</c>. The default value is <c>true</c>.
         */
        showBorder(value?: boolean): any;
        /**
         * Gets or sets whether to print the column header.
         * @param {GcSpread.Sheets.PrintVisibilityType} value Whether to print the column header.
         * @returns {GcSpread.Sheets.PrintVisibilityType} A value that determines whether to print the column header. The default value is GcSpread.Sheets.PrintVisibilityType.Inherit.
         */
        showColumnHeader(value?: PrintVisibilityType): any;
        /**
         * Gets or sets whether to print the grid lines.
         * @param {boolean} value Whether to print the grid lines.
         * @returns {boolean} <c>true</c> to print the grid lines; otherwise, <c>false</c>. The default value is <c>true</c>.
         */
        showGridLine(value?: boolean): any;
        /**
         * Gets or sets whether to print the row header.
         * @param {GcSpread.Sheets.PrintVisibilityType} value Whether to print the row header.
         * @returns {GcSpread.Sheets.PrintVisibilityType} A value that determines whether to print the row header. The default value is GcSpread.Sheets.PrintVisibilityType.Inherit.
         */
        showRowHeader(value?: PrintVisibilityType): any;
        /**
         ...
         * @returns {boolean} <c>true</c> if only rows and columns that contain data are to be printed; otherwise, <c>false</c>. The default value is <c>true</c>.
         */
         ...
         * @returns {number} A value that specifies the amount to enlarge or reduce the printed worksheet. The default value is 1. Specify the value as a number between 0.1 (10% zoom) and 4 (400% zoom).
         */
    ...
    export class RangeGroup{
         ...
         * @returns {GcSpread.Sheets.RangeGroupInfo} The range group information.
         */
    ...
    export class RowHeaderCellType extends BaseCellType{
        /**
    ...
    export class Sheet{
         ...
         * @type {Array.<GcSpread.Sheets.KeyMap>}
         */
        keyMap: KeyMap[];
        /**
         ...
         * @param {GcSpread.Sheets.SlicerStyle} style The style of the slicer.
         * @return {GcSpread.Sheets.Slicer} The slicer that has been added to the sheet.
         */
        addSlicer(name:string, tableName:string, columnName:string, style?:SlicerStyle): Slicer;
        /**
         ...
         * @param {GcSpread.Sheets.SheetArea} sheetArea The sheet area. If this parameter is not given, it defaults to <b>viewport</b>.
         */
         ...
         * @param {GcSpread.Sheets.Range} wholeRange The entire range to fill.
         ...
         * @param {GcSpread.Sheets.Range} startRange The fill start range.
         * @param {GcSpread.Sheets.Range} wholeRange The fill range.
         * @param {GcSpread.Sheets.FillSeries} series The fill series.
         ...
         * @param {GcSpread.Sheets.Range} startRange The fill start range.
         * @param {GcSpread.Sheets.Range} wholeRange The range to fill.
         * @param {GcSpread.Sheets.FillSeries} series The fill series.
         ...
         * @returns {GcSpread.Sheets.Calc.CalcService} The calculation service of the Spread component.
         */
        getCalcService(): Calc.CalcService;
        /**
         ...
         * @returns {GcSpread.Sheets.Rect} Object that contains the size and location of the cell rectangle.
         */
         ...
         * @param {number} col The column index.
         * @param {GcSpread.Sheets.SheetArea} sheetArea The sheet area. If this parameter is not given, it defaults to viewport.
        ...
        /**
         * Gets information for all custom names.
         * @returns {Array} The type GcSpread.Sheets.NameInfo is stored in an Array.
         */
        ...
        getDirtyRows(): any[];
        /**
         * Gets the custom floating objects.
         ...
         */
        getRowVisible(row: number, sheetArea?: SheetArea, ignoreFilterAndGroup?: boolean): boolean;
        /**
         * Gets the selections in the current sheet.
         * @returns {Array} The type GcSpread.Sheets.Range is stored in an Array.
         */
        getSelections(): Range[];
        /**
         * Gets a slicer in the sheet by the name.
         * @param {string} name The name of the slicer.
         * @returns {GcSpread.Sheets.Slicer} The slicer that has the indicated name.
         */
        getSlicer(name: string): Slicer;
        /**
         * Gets all slicers for the sheet.
         * @returns {Array} The slicers on the indicated sheet.
         */
        getSlicers(): Slicer[];
        /**
         * Gets all slicers for the specified table.
         * @param {string} tableName The name of the indicated table.
         * @returns {Array} The slicers on the indicated table.
         */
        getSlicersFromTable(tableName: string): Slicer[];
        /**
         ...
         * @param {GcSpread.Sheets.PrintInfo} value The print information for the sheet.
         * @returns {GcSpread.Sheets.PrintInfo} The print information for the sheet.
         */
        printInfo(value?: PrintInfo): any;
        /**
         * Gets or sets a value that indicates the elements that you want users to be able to change.
         * @param {Object} value The elements that you want users to be able to change.
         * value.allowSelectLockedCells: boolean type, True or undefined if the user can select locked cells.
         * value.allowSelectUnlockedCells: boolean type, True or undefined if the user can select unlocked cells.
         * value.allowSort: boolean type, True if the user can sort ranges.
         * value.allowFilter: boolean type, True if the user can filter ranges.
         * value.allowEditObjects: boolean type, True if the user can edit floating objects.
         * value.allowResizeRows: boolean type, True if the user can resize rows.
         * value.allowResizeColumns: boolean type, True if the user can resize columns.
         * @returns {Object} The elements that you want users to be able to change.
         */
        protectionOption(value?: IProtectionOption): any;
        /**
         ...
         * @param {GcSpread.Sheets.Range} range The new table range. The headers must remain in the same row, and the resulting table range must overlap the original table range.
         * @returns {GcSpread.Sheets.Sheet} The sheet that contains the table.
         */
        resizeTable(table: SheetTable, range: Range): Sheet;
        /**
         * Changes the table size.
         ...
         * @returns {GcSpread.Sheets.Sheet} The sheet that contains the table.
         */
        resizeTableByName(name: string, range: Range): Sheet;
        /**
         ...
         * @param {number} rowCount The number of rows in the range.
         * @param {number} colCount The number of columns in the range.
    ...
    export class SheetTable{
         ...
         * @returns {GcSpread.Sheets.TableSlicerData} The slicer data of the table.
         */
    ...
    export class Slicer extends CustomFloatingObject{
        /**
         * Represents a slicer.
         * @class GcSpread.Sheets.Slicer
         * @param {string} name The slicer name.
         * @param {GcSpread.Sheets.SheetTable} table The table that relates to the slicer.
         * @param {string} columnName The name of the table's column.
         */
        constructor(name: string, table: SheetTable, columnName: string);
        /**
         * Gets or sets the caption name of the slicer.
         * @param {string} value The caption name of the slicer.
         * @returns {string} The caption name of the slicer.
         */
        captionName(value?: string): any;
        /**
         * Gets or sets the column count for the slicer.
         * @param {number} value The column count of the slicer.
         * @returns {number} The column count of the slicer.
         */
        columnCount(value?: number): any;
        /**
         ...
         * @returns {boolean} The setting for whether to disable resizing and moving the slicer.
         */
         ...
         * @returns {number} The item height of the slicer.
         */
        itemHeight(value?: number): any;
        /**
         * Gets or sets the name of the slicer.
         * @param {string} value The name of the slicer.
         * @returns {string} The name of the slicer.
         */
        name(value?: string): any;
        /**
         * Gets or sets whether to show the slicer header.
         * @param {boolean} value The show header setting of the slicer.
         * @returns {boolean} The show header setting of the slicer.
         */
        showHeader(value?: boolean): any;
        /**
         * Gets or sets whether to show the no data items of the slicer.
         * @param {boolean} value The show no data items setting of the slicer.
         * @returns {boolean} The show no data items setting of the slicer.
         */
        showNoDataItems(value?: boolean): any;
        /**
         * Gets or sets whether to show the no data items last.
         * @param {boolean} value The show no data items last setting of the slicer.
         * @returns {boolean} The show no data items last setting of the slicer.
         */
        showNoDataItemsInLast(value?: boolean): any;
        /**
         * Gets or sets the sort state of the slicer.
         * @param {GcSpread.Sheets.SortState} value The sort state of the slicer.
         * @returns {GcSpread.Sheets.SortState} The sort state of the slicer.
         */
        sortState(value?: SortState): any;
        /**
         * Gets or sets the style of the slicer.
         * @param {GcSpread.Sheets.SlicerStyle} value The style of the slicer.
         * @returns {GcSpread.Sheets.SlicerStyle} The style of the slicer.
         */
        style(value?: SlicerStyle): any;
        /**
         * Gets or sets whether to visually distinguish the items with no data.
         * @param {boolean} value The setting for items with no data.
         * @returns {boolean} The setting for items with no data.
    ...
    export class SlicerBorder{
         ...
         * #returns {string} The border style.
         */
        borderStyle(value?: string): any;
        /**
    ...
    export class SlicerStyle{
         ...
         * @param {GcSpread.Sheets.SlicerStyleInfo} item The style of the slicer header.
         * @returns {GcSpread.Sheets.SlicerStyleInfo} Returns the style of the slicer header.
         */
        headerStyle(value?: SlicerStyleInfo): any;
        /**
         * Gets or sets the style of the hovered selected item with data.
         * @param {GcSpread.Sheets.SlicerStyleInfo} item The style of the hovered selected item with data.
         * @returns {GcSpread.Sheets.SlicerStyleInfo} Returns the style of the hovered selected item with data.
         */
        hoveredSelectedItemWithDataStyle(value?: SlicerStyleInfo): any;
        /**
         * Gets or sets the style of the hovered selected item with no data.
         * @param {GcSpread.Sheets.SlicerStyleInfo} item The style of the hovered selected item with no data.
         * @returns {GcSpread.Sheets.SlicerStyleInfo} Returns the style of the hovered selected item with no data.
         */
        hoveredSelectedItemWithNoDataStyle(value?: SlicerStyleInfo): any;
        /**
         * Gets or sets the style of the hovered unselected item with data.
         * @param {GcSpread.Sheets.SlicerStyleInfo} item The style of the hovered unselected item with data.
         * @returns {GcSpread.Sheets.SlicerStyleInfo} Returns the style of the hovered unselected item with data.
         */
        hoveredUnSelectedItemWithDataStyle(value?: SlicerStyleInfo): any;
        /**
         * Gets or sets the style of the hovered unselected item with no data.
         * @param {GcSpread.Sheets.SlicerStyleInfo} item The style of the hovered unselected item with no data.
         * @returns {GcSpread.Sheets.SlicerStyleInfo} Returns the style of the hovered unselected item with no data.
         */
        hoveredUnSelectedItemWithNoDataStyle(value?: SlicerStyleInfo): any;
        /**
         * Gets or sets the name of the style.
         * @returns {string| GcSpread.Sheets.SlicerStyle} Returns the style name. If the name is not set, it returns the slicer style.
         */
        name(value?: string): any;
        /**
         * Gets or sets the style of the selected item with data.
         * @param {GcSpread.Sheets.SlicerStyleInfo} item The style of the selected item with data.
         * @returns {GcSpread.Sheets.SlicerStyleInfo} Returns the style of the selected item with data.
         */
        selectedItemWithDataStyle(value?: SlicerStyleInfo): any;
        /**
         * Gets or sets the style of the selected item with no data.
         * @param {GcSpread.Sheets.SlicerStyleInfo} item The style of the selected item with no data.
         * @returns {GcSpread.Sheets.SlicerStyleInfo} Returns the style of the selected item with no data.
         */
        selectedItemWithNoDataStyle(value?: SlicerStyleInfo): any;
        /**
         * Gets or sets the style of the unselected item with data.
         * @param {GcSpread.Sheets.SlicerStyleInfo} item The style of the unselected item with data.
         * @returns {GcSpread.Sheets.SlicerStyleInfo} Returns the style of the unselected item with data.
         */
        unSelectedItemWithDataStyle(value?: SlicerStyleInfo): any;
        /**
         * Gets or sets the style of the unselected item with no data.
         * @param {GcSpread.Sheets.SlicerStyleInfo} item The style of the unselected item with no data.
         * @returns {GcSpread.Sheets.SlicerStyleInfo} Returns the style of the unselected item with no data.
         */
        unSelectedItemWithNoDataStyle(value?: SlicerStyleInfo): any;
        /**
         * Gets or sets the style of the whole slicer.
         * @param {GcSpread.Sheets.SlicerStyleInfo} item The style of the whole slicer.
         * @returns {GcSpread.Sheets.SlicerStyleInfo} Returns the style of the whole slicer.
         */
        wholeSlicerStyle(value?: SlicerStyleInfo): any;
    }
    ...
    export class SlicerStyleInfo{
         ...
         * @param {GcSpread.Sheets.SlicerBorder} borderLeft The left border of the style information.
         * @param {GcSpread.Sheets.SlicerBorder} borderTop The top border of the slicer information.
         * @param {GcSpread.Sheets.SlicerBorder} borderRight The right border of the style information.
         * @param {GcSpread.Sheets.SlicerBorder} borderBottom The bottom border of the style information.
         * @param {GcSpread.Sheets.TextDecorationType} textDecoration The text decoration of the style information.
         */
        constructor(backColor?: string, foreColor?: string, font?: string, borderLeft?: SlicerBorder, borderTop?: SlicerBorder, borderRight?: SlicerBorder, borderBottom?: SlicerBorder, textDecoration?: TextDecorationType);
        /**
         * Gets or sets the background color of the style information.
         * @param {number} value The background color of the style information.
         * @returns {number} The background color of the style information.
         */
        backColor(value?: string): any;
        /**
         * Gets or sets the bottom border of the style information.
         * @param {number} value The bottom border of the style information.
         * @returns {number} The bottom border of the style information.
         */
        borderBottom(value?: SlicerBorder): any;
        /**
         * Gets or sets the left border of the style information.
         * @param {number} value The left border of the style information.
         * @returns {number} The left border of the style information.
         */
        borderLeft(value?: SlicerBorder): any;
        /**
         * Gets or sets the right border of the style information.
         * @param {number} value The right border of the style information.
         * @returns {number} The right border of the style information.
         */
        borderRight(value?: SlicerBorder): any;
        /**
         * Gets or sets the top border of the style information.
         * @param {number} value The top border of the style information.
         * @returns {number} The top border of the style information.
         */
        borderTop(value?: SlicerBorder): any;
        /**
         * Gets or sets the font of the style information.
         * @param {number} value The font of the style information.
         * @returns {number} The font of the style information.
         */
        font(value?: string): any;
        /**
         * Gets or sets the foreground color of the style information.
         * @param {number} value The foreground color of the style information.
         * @returns {number} The foreground color of the style information.
         */
        foreColor(value?: string): any;
        /**
         * Sets every border of the style information.
         * @param {GcSpread.Sheets.SlicerBorder} value The border setting.
         */
        setBorders(value: SlicerBorder): void;
        /**
         * Gets or sets the text decoration of the style information.
         * @param {GcSpread.Sheets.TextDecorationType} value The text decoration of the style information.
         * @returns {GcSpread.Sheets.TextDecorationType} The text decoration of the style information.
         */
        textDecoration(value?: TextDecorationType): any;
    }
    ...
    export class SlicerStyles{
         ...
         * @returns {GcSpread.Sheets.SlicerStyle}
         */
        static dark1(): SlicerStyle;
        /**
         * Gets the dark2 style.
         * @returns {GcSpread.Sheets.SlicerStyle}
         */
        static dark2(): SlicerStyle;
        /**
         * Gets the dark3 style.
         * @returns {GcSpread.Sheets.SlicerStyle}
         */
        static dark3(): SlicerStyle;
        /**
         * Gets the dark4 style.
         * @returns {GcSpread.Sheets.SlicerStyle}
         */
        static dark4(): SlicerStyle;
        /**
         * Gets the dark5 style.
         * @returns {GcSpread.Sheets.SlicerStyle}
         */
        static dark5(): SlicerStyle;
        /**
         * Gets the dark6 style.
         * @returns {GcSpread.Sheets.SlicerStyle}
         */
        static dark6(): SlicerStyle;
        /**
         * Gets the light1 style.
         * @returns {GcSpread.Sheets.SlicerStyle}
         */
        static light1(): SlicerStyle;
        /**
         * Gets the light2 style.
         * @returns {GcSpread.Sheets.SlicerStyle}
         */
        static light2(): SlicerStyle;
        /**
         * Gets the light3 style.
         * @returns {GcSpread.Sheets.SlicerStyle}
         */
        static light3(): SlicerStyle;
        /**
         * Gets the light4 style.
         * @returns {GcSpread.Sheets.SlicerStyle}
         */
        static light4(): SlicerStyle;
        /**
         * Gets the light5 style.
         * @returns {GcSpread.Sheets.SlicerStyle}
         */
        static light5(): SlicerStyle;
        /**
         * Gets the light6 style.
         * @returns {GcSpread.Sheets.SlicerStyle}
         */
        static light6(): SlicerStyle;
        /**
         * Gets the other1 style.
         * @returns {GcSpread.Sheets.SlicerStyle}
         */
        static other1(): SlicerStyle;
        /**
         * Gets the other2 style.
         * @returns {GcSpread.Sheets.SlicerStyle}
         */
        static other2(): SlicerStyle;
    }
    ...
    export class Spread{
        ...
        name: string;
        /** Represents the sheet collection.
         * @type {Array.<GcSpread.Sheets.Sheet>}
         */
        sheets: Sheet[];
        /**
        ...
        addCustomName(name: string, formula: string, baseRow: number, baseCol: number): void;
        /**
         * Adds a style to the Spread named styles collection.
         * @param {GcSpread.Sheets.Style} style The style to be added.
         */
        addNamedStyle(style: Style): void;
        /**
         ...
         * @param {boolean} value Whether the user can reorder the sheets in the Spread component.
         ...
         * @returns {Object} The image source used to represent the background image of the Spread component.
         */
        backgroundImage(value?: string): any;
        /**
         ...
         * @param {boolean} focusIn Whether the Spread component has the focus. The default value is <c>true</c>.
         */
        ...
        /**
         * Gets the calculation service of the Spread.
         * @returns {GcSpread.Sheets.Calc.CalcService} The calculation service of the Spread.
         */
        getCalcService(): Calc.CalcService;
        /**
         ...
         * @param {boolean} value Whether to display the selection highlighting when the Spread component does not have the focus.
         * @returns {Object} <c>true</c> if the selection highlighting is not displayed the Spread component does not have the focus; otherwise, <c>false</c>.
         */
         ...
         * @param {GcSpread.Sheets.ResizeZeroIndicator} value The drawing policy when the row or column is resized to zero.
         * @returns {GcSpread.Sheets.ResizeZeroIndicator} The drawing policy when the row or column is resized to zero.
         */
        resizeZeroIndicator(value?: ResizeZeroIndicator): any;
        /**
         * Resumes the calculation service.
         * @param {boolean} recalcAll Specifies whether to recalculate all formulas.
         */
         ...
         * @param {boolean} value Whether the scroll bar ignores hidden rows or columns.
         * @returns {Object} <c>true</c> if the scroll bar ignores hidden rows or columns; otherwise, <c>false</c>.
         */
        scrollIgnoreHidden(value?: boolean): any;
        /**
         ...
         * @param {boolean} value Whether to display the sheet tab navigation.
         * @returns {Object} <c>true</c> if the sheet tab navigation is displayed; otherwise, <c>false</c>.
         */
        tabNavigationVisible(value?: boolean): any;
        /**
         ...
         * @param {boolean} value Whether to use touch layout to present the Spread component.
         * @returns {Object} <c>true</c> if using touch layout to present the Spread component; otherwise, <c>false</c>.
         */
    ...
    export class SpreadActions{
        ...
        /**
         * Commits the cell editing and sets the array formula to the active range.
         * @static
         */
    ...
    export class TableSlicerData{
        /**
         * Represents table slicer data.
         * @class GcSpread.Sheets.TableSlicerData
         * @param {GcSpread.Sheets.ISheetTable} table The table.
         */
        constructor(table: SheetTable);
        /**
         * Attaches the listener.
         * @param {GcSpread.Slicer.ISlicerListener} listener The listener.
         */
        attachListener(listener: GcSpread.Slicer.ISlicerListener): void;
        /**
         ...
         * @param {GcSpread.Slicer.ISlicerListener} listener The listener.
         */
        detachListener(listener: GcSpread.Slicer.ISlicerListener): void;
        /**
         ...
         */
        doFilter(columnName: string, conditional: Slicer.ISlicerConditional, isPreview?: boolean): void;
        /**
         ...
         */
        getData(columnName: string, range?: Slicer.ISlicerRangeConditional): any[];
        /**
         * Gets the exclusive data by the specified column name.
         * @param {string} columnName The column name.
         * @returns {Array} The exclusive data corresponding to the specified column name.
         */
        getExclusiveData(columnName: string): any[];
        /**
         * Gets the exclusive data index by the specified column name and data index.
         * @param {string} columnName The column name.
         * @param {number} columnName The index of the data.
         ...
         * @param {string} columnName The column name.
         * @param {GcSpread.Slicer.FilteredOutDataType} filtedOutDataType Indicates which kind of filted out exclusive data index should be included in the result.
         * @returns {Array} The filtered out exclusive data indexes that correspond to the specified column name.
         */
        getFilteredOutIndexes(columnName: string, filtedOutDataType: GcSpread.Slicer.FilteredOutDataType): number[];
        /**
         ...
         */
        getFilteredOutRanges(columnName: string): Slicer.ISlicerRangeConditional[];
        /**
         * Gets the filtered ranges by the specified data name.
         * @param {string} columnName The data name.
         * @returns {Array} The filtered ranges that correspond to the specified data name.
         */
        getFilteredRanges(columnName: string): Slicer.ISlicerRangeConditional[];
        /**
         ...
         * @returns {GcSpread.Sheets.ISheetTable} The table of the table slicer data.
         */
        getTable(): SheetTable;
        /**
         * Refresh the table slicer data.
         */
        refresh(): void;
    }
    ...
    export class TableStyleInfo{
         ...
         * @param {GcSpread.Sheets.TextDecoration} textDecoration The text decoration of the table.
         */
        constructor(backColor?: string, foreColor?: string, font?: string, borderLeft?: LineBorder, borderTop?: LineBorder, borderRight?: LineBorder, borderBottom?: LineBorder, borderHorizontal?: LineBorder, borderVertical?: LineBorder, textDecoration?: TextDecorationType);
        /**
         * Indicates the background color.
         * @type {string}
         */
    ...
    export class Top10Condition{
         ...
         */
        ignoreBlank: boolean;
        /** Gets or sets the cell range of the condition.
         * @type {Array.<GcSpread.Sheets.Range>}
         */
        ranges: Range[];
    ...
    export class TouchToolStrip{
         ...
         */
        constructor(spread: any, host: HTMLElement);
        /**
    ...
    export class UniqueCondition{
        ...
        /** Specifies whether the expected value is duplicated.
         * @type {boolean}
         */
        expected: boolean;
        /** Specifies whether to ignore the blank cell.
...
declare module GcSpread.Sheets.Calc{
    ...
    export class AsyncEvaluateContext{
         ...
         */
        constructor(context: EvaluateContext, expression: Calc.Expressions.Expression);
        /**
    ...
    export class CalcService{
         ...
         * @param {GcSpread.Sheets.Calc.CalcSource} source The CalcSource.
         * @returns {GcSpread.Sheets.Calc.Expressions.CalcSourceModel} The CalcSourceModel.
         */
        getSourceModel(source: Object): CalcSourceModel;
        /**
         ...
         */
        recalculate(source: Object, row: number, column: number, recalcVolatitles?: boolean): void;
        /**
         * Recalculates all dirty cells.
         * @param {boolean} dirtyAll Specifies whether to recalcute all formulas.
         */
        recalculateAll(dirtyAll?: boolean, recalcVolatitles?: boolean): void;
        /**
         * Recalculates one name and all of the dependent cells and names.
         * @param {GcSpread.Sheets.Calc.CalcSource} source The CalcSource.
         * @param {string} name The name.
         */
        recalculateByName(source: Object, name: string): void;
        /**
    ...
    export class CalcSource{
        /**
         * Represents a source, usually bound to a sheet; however, you can set up group elements as a source.
         * @class
         * @param {GcSpread.Sheets.Calc.CalcService} service The CalcService that the CalcSource worked in.
         */
        constructor(service: CalcService);
        /**
         * Gets the relative calculation service.
         * @returns {GcSpread.Sheets.Calc.CalcService} The calculation service.
         */
         ...
         * @returns {GcSpread.Sheets.Calc.CalcSourceModel} The relative CalcSourceModel.
         */
        getCalcSourceModel(): CalcSourceModel;
        /**
         * Gets the column count of current source.
         * @returns {number} The column count of current source.
         */
        getColumnCount(): number;
        /**
         * Gets the custom function by function name.
         * @param {name} name The name of the function.
         * @returns {GcSpread.Sheets.Calc.Functions.Function} The function.
         */
        getCustomFunction(name: string): Calc.Functions.Function;
        /**
         * Gets the custom name.
         * @param {name} name The name.
         * @returns {GcSpread.Sheets.Calc.Expressions.Expression} The custom name expression.
         */
        getCustomName(name:string): Expressions.Expression;
        /**
         * Gets the evaluator context.
         * @param {number} row The row.
         * @param {number} col The column.
         * @param {boolean} arrayFormula Is array formula.
         * @param {number} baseRow The base row for the array formula.
         * @param {number} baseCol The base column for the array formula.
         * @param {number} rowCount The row count for the array formula.
         * @param {number} colCount The columnCount for the array formula.
         * @returns {GcSpread.Sheets.Calc.EvaluateContext} The evaluate context.
         */
        getEvaluatorContext(row: number, col: number, arrayFormula: boolean, baseRow: any, baseCol: any, rowCount: any, colCount: any): EvaluateContext;
        /**
         * Gets the name of this CalcSource.
         * @returns {object} The name.
         */
        getName(): string;
        /**
         * Gets the parser context.
         * @param {boolean} useR1C1 Whether to use R1C1.
         * @param {number} baseRow The row.
         * @param {number} baseColumn The column.
         * @param {object} option The parser symbol option.
         * @returns {GcSpread.Sheets.Calc.ParserContext} The parser context.
         */
        getParserContext(useR1C1: boolean, baseRow: number, baseColumn: number, option?:IParserOption):ParserContext;
        /**
         * Gets the reference.
         * @param {number} row The row.
         * @param {number} column The column.
         * @param {number} rowCount The rowCount.
         * @param {number} columnCount The columnCount.
         * @returns {GcSpread.Sheets.Calc.Reference} The reference.
         */
        getReference(row: number, column: number, rowCount: number, columnCount: number): Calc.Reference;
        /**
         * Gets the row count of current source.
         * @returns {number} The row count of current source.
         */
        getRowCount(): number;
        /**
         ...
         * @param {number} row The row.
         * @param {number} column The column.
         * @param {GcSpread.Sheets.Calc.CalcValueType} valueType The value type that the calculation engine needs.
         * @returns {object} The value.
         */
        getValue(row: number, column: number, valueType?: CalcValueType): any;
        /**
         * Gets the value by name.
         * @param {string} nameIdentity The name.
         * @param {GcSpread.Sheets.Calc.CalcValueType} valueType The value type that the calculation engine needs.
         * @returns {object} The value.
         */
        getValueByName(nameIdentity: string, valueType?: CalcValueType): any;
        /**
         * Specifies the row is a hidden row for the SUBTOTAL function.
         * @param {number} row The row.
         * @param {boolean} onlyFiltered Only returns the filted out row.
         * @returns {boolean} <c>true</c> if the row is a hidden row; otherwise, <c>false</c>.
         */
        isHiddenRow(row: number, onlyFiltered?: boolean):boolean;
        /**
         * Sets the array formula to the CalcSource.
         * @param {number} row The row.
         * @param {number} column The column.
         * @param {number} rowCount The row count.
         * @param {number} columnCount The column count.
         * @param {string} formula The formula.
         */
        setArrayFormula(row: number, column: number, rowCount:number, columnCount:number, formula: string): any;
        /**
         ...
         * @param {string} formula The formula.
         */
        setFormula(row:number, column: number, formula: string): any;
        /**
         * Sets the formula to the CalcSource.
         * @param {string} name The name.
         * @param {string} formula The formula.
         */
        setFormulaByName(name: string, formula: string): any;
        /**
         * Sets the calculated result to the CalcSource.
         * @param {number} row The row.
         * @param {number} column The column.
         * @param {object} value The value.
         */
         ...
         * @param {object} value The value.
         */
        setValueByName(nameIdentity: string, value: any): void;
    }

    export class CalcSourceModel{
        /**
         * Represents a calculation source model which is used for storing all formulas and their dependents for one CalcSource.
         * @class
         * @param {GcSpread.Sheets.Calc.CalcService} service The CalcService that the CalcSourceModel worked in.
         * @param {GcSpread.Sheets.Calc.CalcSource} service The relative CalcSource.
         */
        constructor(service: CalcService, source: Object);
        /**
        ...
        getCalcService(): CalcService;
        /**
         * Gets the formula from the calculation engine.
         * @param {number} row The row.
         * @param {number} col The column.
         ...
         * @returns {string} The formula.
         */
        getFormulaByName(name: string): string;
        /**
         * Gets the relative CalcSource
         * @returns {GcSpread.Sheets.Calc.CalcSource} The relative CalcSource
         */
        getSource(): Object;
        /**
         ...
         * @param {string} formula The formula.
         */
        setArrayFormula(row: number, col: number, rowCount: number, colCount: number, formula: any, ignoreError?: boolean): any;
        /**
         ...
         * @param {string} formula The formula.
         */
        setFormula(row: number, col: number, formula: string, ignoreError?: boolean): void;
        /**
         * Sets the formula to the calculation engine.
         * @param {number} row The row.
         * @param {number} col The column.
         * @param {string} formula The formula.
         */
        setFormulaByName(name: string, formula: string, ignoreError?: boolean): void;
    }
    ...
    export class EvaluateContext{
         ...
         * @param {number} baseRow The row index of the cell you want to evaluate or the top left row index of the array formula.
         * @param {number} baseColumn The column index of the cell you want to evaluate or the top left column index of the array formula.
         * @param {number} rowCount The row count of the array formula.
         * @param {number} columnCount The column count of the array formula.
         * @param {number} activeRow The row index of the cell you want to evaluate.
         * @param {number} activeColumn The column index of the cell you want to evaluate.
         */
    ...
    export class Evaluator{
         ...
         */
        evaluateExpression(expression: Expressions.Expression, evaluatorContext?: EvaluateContext, convertNullToZero?:boolean, acceptsArray?: boolean, acceptsReference?: boolean): any;
    }
    ...
    export class ParserContext{
         ...
         * @class
         * @param {GcSpread.Sheets.Calc.CalcSource} source The  parser calc source
    ...
    export class Reference{
        ...
        /**
         * Gets the number of ranges in the current area.
         ...
         * @param {number} range The range index.
         * @param {number} rowOffset The row offset.
         * @param {boolean} onlyFiltered Only considers the filtered hidden row.
    ...
    export class SheetReference extends Reference{
        /**
         * Represents a sheet range referenced in a spreadsheet.
         * @param {GcSpread.Sheets.Calc.CalcSource} row The row.
         * @param {number} row The relative CalcSource.
         * @param {Array} ranges The referenced ranges.
         * @class
         */
        constructor(calcSource: Object, ranges?: any[]);
    }
    module Expressions{
        ...
        export class CellExpression extends ReferenceExpression{
            /**
        ...
        export class ExternalCellExpression extends ExternalReferenceExpression{
            /**
             * Represents a cell reference expression.
        ...
        export class ExternalNameExpression extends NameExpression{
            /**
             * Represents an expression with a named variable as the expression.
             * @extends GcSpread.Sheets.Calc.Expressions.NameExpression
             * @class
        ...
        export class ExternalNameIdentityExpression extends Expression{
            /**
             * Represents a name identity at CalcSource, can getValue/setValue/setFormula/getFormula by CalcSource directly by the name.
             * @extends GcSpread.Sheets.Calc.Expressions.Expression
             * @class
             * @param {GcSpread.Sheets.Calc.CalcSource} source The source of the name identity.
             * @param {string} nameIdentity The name identity.
             */
            constructor(source: Object, nameIdentity: string);
        }

        export class ExternalRangeExpression extends ExternalReferenceExpression{
            /**
        ...
        export class NameIdentityExpression extends Expression{
            /**
             * Represents a name identity at CalcSource, can getValue/setValue/setFormula/getFormula by CalcSource directly by the name.
             * @extends GcSpread.Sheets.Calc.Expressions.Expression
             * @class
        ...
        export class RangeExpression extends ReferenceExpression{
            /**
             * Represents a cell range reference expression.
             * @extends GcSpread.Sheets.Calc.Expressions.ReferenceExpression
             * @class
        ...
        export class SheetRangeExpression extends ReferenceExpression{
            /**
        ...
        export class StructReferenceExpression extends ReferenceExpression{
             ...
             * @extends GcSpread.Sheets.Calc.Expressions.ReferenceExpression
             * @class
             * @param {string} structRef The structured reference string.
             */
    ...
    module Functions{
        ...
        export enum ArrayArgumentEvaluateMode{
            /**
             *  Expands the array or range arguments normally.
             */
            normal = 0,
            /**
             *  Always expands the range arguments as array formula.
             */
            allwaysExpand = 1,
            /**
             *  Never expands the array or range arguments.
             */
            neverExpand = 2
        }
...
declare module GcSpread.Sheets.UndoRedo{
    ...
    export class ClipboardPasteFloatingObjectUndoAction{
        /**
    ...
    export class DragCopyFloatingObjectUndoAction{
        /**
...
declare module GcSpread.Slicer{
    ...
    export interface ISlicerData{
        ...
        getFilteredOutIndexes(columnName: string, filtedOutDataType: FilteredOutDataType, isPreview?: boolean): number[];
    ...
    export interface ISlicerListener{
        ...
        onRowsChanged(rowIndex: number, rowCount: number, isAdd: boolean);
    ...
    export class GeneralSlicerData implements ISlicerData{
        /**
         * Represents general slicer data.
         * @class GcSpread.Slicer.GeneralSlicerData
         ...
         * @param {number} rowCount The number of rows to add.
         */
        addRows(rowIndex: number, rowCount: number): void;
        /**
         * Aggregates the data by the specified column name.
         * @param {string} columnName The column name.
         * @param {GcSpread.Slicer.SlicerAggregateType} aggregateType The aggregate type.
         * @param {object} range The specific range.
         * range.min: number type, the minimum value.
         * range.max: number type, the maximum value.
         ...
         * @param {GcSpread.Slicer.SlicerDataItem} changedData The changed data item in the data source.
         */
        changeData(changedDataItem: ISlicerDataItem[]): void;
        /**
         * Clears the preview filter state.
         */
        clearPreview(): any;
         ...
         */
        doFilter(columnName: string, conditional: ISlicerConditional, isPreview?: boolean): void;
        /**
         * Unfilters the data that corresponds to the specified column name.
         * @param {string} columnName The column name.
         */
         ...
         * @returns {number} The exclusive data index that corresponds to the specified data name and data index.
         */
        getExclusiveRowIndex(columnName: string, rowIndex: number): number;
        /**
         * Gets the filtered exclusive data indexes by the specified data name.
         * @param {string} columnName The data name.
         * @returns {Array} The filtered exclusive data indexes that correspond to the specified data name.
         */
        getFilteredIndexes(columnName: string): number[];
        /**
         * Gets the filtered out exclusive data indexes by the specified column name.
         * @param {string} columnName The column name.
         * @param {GcSpread.Slicer.FilteredOutDataType} filtedOutDataType Indicates the kind of filtered out exclusive data index that should be included in the result.
         * @returns {Array} The filtered out exclusive data indexes that correspond to the specified column name.
         */
        getFilteredOutIndexes(columnName: string, filtedOutDataType: FilteredOutDataType): number[];
        /**
         * Gets the filtered out ranges by other columns.
         * @param {string} columnName The column name.
         * @returns {Array} The filtered out ranges by other columns that correspond to the specified column name.
    ...
    export class SlicerDataItem implements ISlicerDataItem{
        /**
         * Represents a slicer data item.
         * @class GcSpread.Slicer.SlicerDataItem.
         * @param {string} columnName The column name of the slicer data item.
         * @param {number} rowIndex The data index of the slicer data item.
         * @param {} data The data of the slicer data item.
         */
        constructor(columnName: string, rowIndex: number, data: any);
        /**
